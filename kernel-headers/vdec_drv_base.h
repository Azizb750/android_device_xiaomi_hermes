...
typedef struct __VDEC_DRV_BASE_T
{
    ...
    VAL_UINT32_T(*Init_ex)(VAL_HANDLE_T *handle, VAL_HANDLE_T halhandle, VAL_HANDLE_T valhandle, P_VDEC_DRV_RINGBUF_T pBitstream, P_VDEC_DRV_SEQINFO_T pSeqinfo, VDEC_DRV_VIDEO_FORMAT_T eFormat, VAL_VOID_T *pConfig);     ///< Function to do driver Initialization
} VDEC_DRV_BASE_T;
