 ...
 *---------------------------------------------------------------------------*/
#ifndef __KEY_BLOCK_PUB_H__
#define __KEY_BLOCK_PUB_H__
...
int write_plain_content(int id,unsigned char * content,unsigned int length);

int get_plain_content(int id,unsigned char ** content,unsigned int * length);
...
int get_plaintext_drmkey ( unsigned char *encDrmKeyBlock, unsigned int inLength,
                     unsigned int *plainTextKeyLen, unsigned char **plainTextKeyBuf);
void free_plaintext_drmkey(unsigned char *decDrmKeyPlainTextBuf);
//end for tee using
